...
function graph() {
  ...
  const graph = svg.append("g").attr("transform", `translate(${325}, ${325})`);
  ...
  const tip = d3Tip()
    .attr("class", "tip card")
    .html(d => {
      let artistName = d.data.artist.includes("_")
        ? d.data.artist.split("_").join(" ")
        : d.data.artist;
          ...
          .on("click", function(d, i, n) {
            ...
            if (trigger === "true") {
              ...
              setTimeout(() => {
                ...
                document.querySelector("div.graph-container").append(nameDiv);
                ...
                axios({
                  ...
                  if (response.data.extract.length > 678) {
                    textBoxDiv.innerHTML =
                      `${response.data.extract.substring(0, 678)}... ` +
                      `<a class="bio-link" target="_blank" href=https://en.wikipedia.org/wiki/${d.data.artist}> Read More</a>`;
                  } else {
                    textBoxDiv.innerHTML =
                ...
                document
                  .querySelector("div.graph-container")
                  .append(textBoxDiv);
                ...
                el.addEventListener("click", function() {
                  document
                    .querySelector("div.text-box")
                    .classList.add("fade-out");
                  document
                    .querySelector("div.name-box")
                    .classList.add("fade-out");
                  document
                    .querySelector("div.remove-box")
                    .classList.add("fade-out");
                  setTimeout(() => {
