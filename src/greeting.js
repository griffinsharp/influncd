...
function greeting() {
  ...
  intro.innerHTML =
    "1. Hover your cursor over a slice of the chart. Each slice represents an artist.";
  ...
  links.innerHTML =
    "3. Done? Click the button below the chart to return back to the starting position.";
  ...
  links2.innerHTML =
    "Want to learn more about the technologies used or how 'relative influence' is calculated?";
  ...
  links3.innerHTML =
    "Click on the 'about' tab (left side of the page) or checkout the <a class='quartz-allmusic' target='_blank' href=https://github.com/griffinsharp/INFLUNCD>github repo.</a>";
